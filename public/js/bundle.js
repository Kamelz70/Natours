...
var rootURL = "https://natourskamelaliz.herokuapp.com/api/v1";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "GET",
              url: "".concat(rootURL, "/users/logout")
            });
          case 3:
            res = _context2.sent;
            if (res.data.status === "success") {
          ...
          case 7:
            ...
            // console.log(err);
            (0, _alerts.showAlert)("error", "Logut Error, Try again");
          case 10:
          case "end":
...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map((_mapboxgl$Map = {
    scrollZoom: false,
    style: "mapbox://styles/kamelz70/cla4kyt0f00k914qte3vfcdsl",
    container: 'map'
  }, _defineProperty(_mapboxgl$Map, "style", 'mapbox://styles/mapbox/streets-v11'), _defineProperty(_mapboxgl$Map, "center", [-74.5, 40]), _defineProperty(_mapboxgl$Map, "zoom", 10), _defineProperty(_mapboxgl$Map, "center", [-118.113491, 34.111745]), _defineProperty(_mapboxgl$Map, "projection", 'globe'), _mapboxgl$Map));
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var rootURL = "http://127.0.0.1:3000/api/v1/users";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "password" ? "".concat(rootURL, "/updateMyPassword") : "".concat(rootURL, "/updateMe");
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51M4ELiHEzzss8Cm6IneYPNqj0t710LtvAUx5EAcTshhxDQAlyo69G8JYoBQT78tmp5gGShDZIjew0bP5kRNH1iUX00V3pNA1mZ');
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var passwordButton, passwordCurrent, password, passwordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              passwordButton = document.querySelector('.btn--save-password');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "30043" + '/');
